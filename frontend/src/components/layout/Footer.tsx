      ...
      <div className="container px-4 md:px-6 py-6 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-2 flex flex-col gap-2 text-sm">
              <a
                href="https://github.com/prgrms-be-devcourse/NBE5-7-1-Team05"
                target="_blank"
        ...
        <div className="pt-4 border-t flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} NBE5-7-1-Team05. All rights reserved.
          </p>
          <p className="text-xs text-muted-foreground mt-2 md:mt-0">
            Made with 💻 by Team 5 at Programmers DevCourse
          </p>
        </div>
      </div>
    </footer>
